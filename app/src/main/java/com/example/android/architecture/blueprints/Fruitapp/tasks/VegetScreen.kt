...
fun vegetScreen(
    ...
    viewModel: vegetViewModel = hiltViewModel(),
    ...
    Scaffold(
        ...
        fruitsContent(
            ...
            currentFilteringLabel = uiState.filteringUoInfo.currentFilteringLabel,
            nofruitsLabel = uiState.filteringUoInfo.nofruitsLabel,
            nofruitsIconRes = uiState.filteringUoInfo.nofruitIconRes,
            onRefresh = viewModel::refresh,
