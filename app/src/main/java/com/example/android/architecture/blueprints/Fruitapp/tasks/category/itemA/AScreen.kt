...
fun cScreen(
    ...
    viewModel: cViewModel = hiltViewModel(),
    ...
    Scaffold(
        ...
        fruitsContent(
            ...
            currentFilteringLabel = uiState.filteringUcInfo.currentFilteringLabel,
            nofruitsLabel = uiState.filteringUcInfo.nofruitsLabel,
            nofruitsIconRes = uiState.filteringUcInfo.nofruitIconRes,
            onRefresh = viewModel::refresh,
