...
import com.example.android.architecture.blueprints.Fruitapp.TodoDestinations
import com.example.android.architecture.blueprints.Fruitapp.TodoNavigationActions
...
private fun DrawerHeader(
    ...
    Column(
        ...
        Image(
            ...
            contentDescription =
            stringResource(id = R.string.fruits_header_image_content_description),
...
fun PreviewAppDrawer() {
    AppCompatTheme {
        Surface {
            AppDrawer(
                currentRoute = TodoDestinations.fruitS_ROUTE,
                navigateTofruits = {},
                navigateToStatistics = {},
                closeDrawer = {}
            )
