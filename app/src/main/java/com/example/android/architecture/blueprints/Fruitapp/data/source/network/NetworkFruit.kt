...
/**
 * Internal model used to represent a fruit obtained from the network. This is used inside the data
 * layer only.
 *
...
data class Networkfruit(
    ...
    val status: fruitStatus = fruitStatus.ACTIVE
)

enum class fruitStatus {
    ACTIVE,
    COMPLETE
}
